    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_file', models.ImageField(storage=picture.models.PictureFileSystemStorage(), upload_to=picture.models.set_pathname)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pictures', models.ManyToManyField(blank=True, to='picture.Picture')),
            ],
        ),
        migrations.CreateModel(
            name='Album',
        ...
        migrations.AddIndex(
            model_name='picture',
            index=models.Index(fields=['sha1', 'user'], name='picture_pic_sha1_0b1786_idx'),
        ),
